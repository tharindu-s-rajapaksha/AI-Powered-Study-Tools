...
2. Explain everything simply in සිංහල language (like explaining to a friend)
3. Include ALL the exact details in Sinhala - do not skip or omit anything
4. Add important points, concepts, and definitions in both Sinhala and English (since I need to learn in English)
5. Extract and include ALL concepts, definitions, explanations, and examples mentioned
6. Preserve the original logical flow and sequence of the lecture content
7. Include every specific detail, example, and explanation from the transcription
8. Highlight key points that would be important for exams
9. Use clear, organized formatting with bullet points and sections
10. Do NOT skip, omit, or summarize any content - preserve everything
11. Keep the same teaching progression and order as the original lecture
12. Use Markdown formatting

DETAILED NOTES (in සිංහල with important terms in English, maintaining exact order):"""
...
3. Write the final notes simply in සිංහල language (like explaining to a friend)
4. Include ALL the exact details in Sinhala - nothing should be omitted
5. Keep important points, concepts, and definitions in both Sinhala and English
6. Remove redundancy ONLY if the exact same information is repeated, but keep the order
7. Create clear sections and subsections with appropriate headings while maintaining sequence
8. Ensure smooth transitions between topics without changing their order
9. Highlight the most important concepts for exam preparation
10. Maintain all specific examples, definitions, and detailed explanations in their original positions
11. Use markdown formatting for better readability
12. The final note must follow the same teaching progression as the original lecture

Create a complete, exam-ready study note in සිංහල that maintains the exact order and includes all content (with key terms in English):"""
...
4. Add important points, concepts, and definitions in both Sinhala and English (since I need to learn in English)
5. Extract and include ALL concepts, definitions, explanations, and examples mentioned
6. Preserve the original sequence and flow of the lecture content
7. Include every specific detail and explanation from the transcription
8. Organize content with clear headings and structure while maintaining the original order
9. Highlight key points important for exams
10. Use markdown formatting for better readability
11. Do NOT skip, omit, or reorder any content - preserve everything in sequence
12. The note must follow the same teaching progression as the original lecture

COMPREHENSIVE STUDY NOTES (in සිංහල with important terms in English, maintaining exact order and all content):"""
