...
TASK
- You are given PDF pages {start_page}-{end_page} from a research paper that was explained by a lecturer in class.
- The lecturer has highlighted the important parts of the research paper that students should know for the exam.

⚠️ CRITICAL RULES — MUST FOLLOW:
1. ✅ YOU MUST explain EVERY SINGLE highlighted part on each page — no highlighted content should ever be skipped or missed.
2. ❌ DO NOT explain or mention any non-highlighted content. Non-highlighted parts are completely irrelevant and must be ignored entirely.
3. If you are unsure whether something is highlighted, err on the side of including it.

- Use the lecture transcription above (if provided) to enhance your explanation of the highlighted parts — if the lecturer explained a highlighted concept in the transcription, include that explanation and clearly mention it like: "The lecturer explained that...", "According to the lecturer...".
- If no transcription is provided, explain the highlighted parts based on the research paper content alone.
...
- Include ALL the exact details from the highlighted parts but explain them in the SIMPLEST {LANGUAGE} possible — do not skip or omit any highlighted content, just make it easy to understand.
...
---PAGE {start_page}---
[Very clear and detailed {LANGUAGE} explanation of ALL highlighted parts on page {start_page}]

---PAGE {start_page + 1}---
[Very clear and detailed {LANGUAGE} explanation of ALL highlighted parts on page {start_page + 1}]

- Continue the same pattern up to page {end_page}.
- If a page has no highlighted content, write: "No highlighted content on this page."
...
<body>
    ...
    def get_or_create_summary(self, pdf_path: str):
        ...
        try:
            ...
            # Generate summary
            summary_prompt = """
Please provide a comprehensive summary of this entire research paper PDF.
Include:
1. Main topics and concepts covered
2. Key themes and their relationships
3. Overall structure and flow of the content

Keep the summary detailed enough to give context for explaining specific highlighted sections later.
